...
```{r, echo=FALSE, include_graphics8, out.width='100%', fig.cap='Figure 8: Google Earth Engine User Interface', fig.scap='@amaniGoogleEarthEngine2020a', cache=FALSE}
...
```{r, echo=FALSE, include_graphics9, out.width='100%', fig.cap='Figure 9: NDVI Slider Application', fig.scap='Image Source: https://khaledalshamaa.users.earthengine.app/view/modis-ndvi-slider', cache=FALSE}
knitr::include_graphics('figures/w5p3.png')
```

```{r, echo=FALSE, include_graphics10, out.width='100%', fig.cap='Figure 10: NDVI Slider Application', fig.scap='Image Source: https://khaledalshamaa.users.earthengine.app/view/modis-ndvi-slider', cache=FALSE}
...
```{r, echo=FALSE, include_graphics11, out.width='100%', fig.cap='Figure 11: Global Drought Severity Index', fig.scap='Image Source: @khanGlobalDroughtMonitoring2021 ', cache=FALSE}
...
```{r, echo=FALSE, include_graphics12, out.width='100%', fig.cap='Figure 12: Acute Food Insecurity Area Classification Map', fig.scap='Image Source: https://fews.net/ ', cache=FALSE}
...
GEE almost sounds a bit too good to be true, especially because it is free to use, at least for non-commercial purposes. I was curious to understand some of the issues or challenges related to GEE and had a look through the literature of this week. According to @amaniGoogleEarthEngine2020, @gorelickGoogleEarthEngine2017, some of the limitation include:
