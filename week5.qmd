...
```{r, message=FALSE, include_graphics8, out.width='100%', fig.cap='Figure 8: Google Earth Engine User Interface', fig.scap='@amaniGoogleEarthEngine2020a'}
...
```{r, message=FALSE, include_graphics9, out.width='100%', fig.cap='Figure 9: NDVI Slider Application', fig.scap='Image Source: https://khaledalshamaa.users.earthengine.app/view/modis-ndvi-slider'}
knitr::include_graphics('figures/w5p3.png')
```

```{r, message=FALSE, include_graphics10, out.width='100%', fig.cap='Figure 10: NDVI Slider Application', fig.scap='Image Source: https://khaledalshamaa.users.earthengine.app/view/modis-ndvi-slider'}
...
```{r, message=FALSE, include_graphics11, out.width='100%', fig.cap='Figure 11: Global Drought Severity Index', fig.scap='Image Source: @khanGlobalDroughtMonitoring2021 '}
...
```{r, message=FALSE, include_graphics12, out.width='100%', fig.cap='Figure 12: Acute Food Insecurity Area Classification Map', fig.scap='Image Source: https://fews.net/ '}
