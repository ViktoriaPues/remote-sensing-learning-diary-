...
```{r, message=FALSE, include_graphics?, out.width='100%', fig.cap='Figure 4: Google Earth Engine User Interface', fig.scap='@amaniGoogleEarthEngine2020a'}
...
```{r, message=FALSE, include_graphics7, out.width='100%', fig.cap='Figure 6: Acute Food Insecurity Area Classification Map, fig.scap='Image Source: @https://fews.net/'}
