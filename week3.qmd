...
```{r, message=FALSE, include_graphics3, out.width='100%', fig.cap='Figure 3:Darawi', fig.scap='Image Source: Principles of Remote Sensing'}
...
```{r, message=FALSE, include_graphics4, out.width='100%', fig.cap='Figure 4: Informal Settlement Mapper', fig.scap='Image Source: Principles of Remote Sensing'}
