...
```{r, echo=FALSE, include_graphics17, out.width='100%', fig.cap='Figure 17: Accuracy', fig.scap='Andy Slides', cache=FALSE}
...
```{r, echo=FALSE, include_graphics18, out.width='100%', fig.cap='Figure 18: Workflow', fig.scap='@matariraObjectBasedInformalSettlement2022', cache=FALSE}
