...
```{r, echo=FALSE, include_graphics13, out.width='100%', fig.cap='Figure 13: Classification', fig.scap='jeffreya.cardilleCloudBasedRemoteSensing', cache=FALSE}
...
```{r, echo=FALSE, include_graphics14, out.width='100%', fig.cap='Figure 14: Random Forests', fig.scap='https://medium.com/analytics-vidhya/random-forest-classifier-and-its-hyperparameters-8467bec755f6', cache=FALSE}
...
Unsupervised classification works the other way around. The classes are grouped first based on the data, using a self-taught algorithm, and then categorized into clusters. There is no reference data, where we know what category it is, in this case. According to @jeffreya.cardilleCloudBasedRemoteSensing, the typical work flow us as follows:  
...
```
```{r, echo=FALSE, include_graphics15, out.width='100%', fig.cap='Figure 15: Damange Assessment Allepo', fig.scap='[@MonitoringWarDestructiona]', cache=FALSE}
