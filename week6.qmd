...
```{r, message=FALSE, include_graphics13, out.width='100%', fig.cap='Figure 13: Classification', fig.scap='jeffreya.cardilleCloudBasedRemoteSensing', cache=FALSE}
