...
```{r, message=FALSE, include_image, out.width='100%', fig.cap='Figure 3: Senitnel 2 image of Mosampique flooding including in Maputo', fig.scap='Image Source: Principles of Remote Sensing'}
