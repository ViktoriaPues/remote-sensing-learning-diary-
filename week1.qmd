...
```{r, echo=FALSE, include_graphics1, out.width='100%', fig.cap='Figure 1: Amplitude, length, and frequency of electric wave', fig.scap='Image Source: Principles of Remote Sensing', cache=FALSE}
...
```{r, echo=FALSE, include_graphics2, out.width='100%', fig.cap='Figure 2: Overview of the EMS', fig.scap='Remote Sensing for Dummies', cache=FALSE}
