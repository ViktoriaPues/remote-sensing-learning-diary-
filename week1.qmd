...
```{r include_image, out.width='100%', fig.cap='Figure 1: Electric and magnetic waves in the electromagnetic field', fig.scap='Image Source: Principles of Remote Sensing'}
