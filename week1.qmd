...
```{r, message=FALSE, include_graphics3, out.width='100%', fig.cap='Figure 3: Workflow Flood Mapping', fig.scap='Image Source: Mehmood et.al.'}
...
```{r, message=FALSE, include_graphics4, out.width='100%', fig.cap='Figure 4: Senitnel 2 image of Mosampique flooding including in Maputo', fig.scap='Image Source: Principles of Remote Sensing'}
